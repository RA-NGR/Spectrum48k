...
void Browser::drawSettingsString()
{
	...
	drawString(settingString, 0, 24, 0xF7BD, 0x1700, false);
	settingString = "  SNOW-эфф.: "; settingString += snowStr[0]; settingString += "                       ";
...
//	drawString("                                        ", 0, 24, 0xFFFF, 0x1700);
	...
	drawString(" F1:Спр F2:Громк F3:48/128 F4:*  F5:Вых ", 0, 28, 0xE0FF, 0x1700, false);
