...
private:
// New way
	//void processULA(uint16_t addressOnBus, uint32_t tStates);
	void (*drawFunc)(ZXSpectrum&, int32_t, bool);
	friend void drawTopBlank(ZXSpectrum& rInstance, int32_t tStates, bool isContended);
	friend void drawTopBorder(ZXSpectrum& rInstance, int32_t tStates, bool isContended);
	friend void drawScreen(ZXSpectrum& rInstance, int32_t tStates, bool isContended);
	friend void drawBottomBorder(ZXSpectrum& rInstance, int32_t tStates, bool isContended);
	friend void drawBottomBlank(ZXSpectrum& rInstance, int32_t tStates, bool isContended);
	//void (*drawFunc)(ZXSpectrum*, int32_t, bool);
	//friend void drawTopBlank(ZXSpectrum* pInstance, int32_t tStates, bool isContended);
	//friend void drawTopBorder(ZXSpectrum* pInstance, int32_t tStates, bool isContended);
	//friend void drawScreen(ZXSpectrum* pInstance, int32_t tStates, bool isContended);
...
// Graphics out
	...
	const uint16_t m_pixelsMemOffset[240] = { 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF,
											  0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0x0000, 0x0100, 0x0200, 0x0300, 0x0400, 0x0500, 0x0600, 0x0700,
											  ...
											  0x10E0, 0x11E0, 0x12E0, 0x13E0, 0x14E0, 0x15E0, 0x16E0, 0x17E0, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF,
											  0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF
	};
	const uint16_t m_attributesMemOffset[240] = { 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, // 0 - 15
												  0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0x1800, 0x1800, 0x1800, 0x1800, 0x1800, 0x1800, 0x1800, 0x1800, // 16 - 31
												  0x1820, 0x1820, 0x1820, 0x1820, 0x1820, 0x1820, 0x1820, 0x1820, 0x1840, 0x1840, 0x1840, 0x1840, 0x1840, 0x1840, 0x1840, 0x1840, // 32 - 47
												  0x1860, 0x1860, 0x1860, 0x1860, 0x1860, 0x1860, 0x1860, 0x1860, 0x1880, 0x1880, 0x1880, 0x1880, 0x1880, 0x1880, 0x1880, 0x1880, // 48 - 63
												  0x18A0, 0x18A0, 0x18A0, 0x18A0, 0x18A0, 0x18A0, 0x18A0, 0x18A0, 0x18C0, 0x18C0, 0x18C0, 0x18C0, 0x18C0, 0x18C0, 0x18C0, 0x18C0, // 64 - 79
												  0x18E0, 0x18E0, 0x18E0, 0x18E0, 0x18E0, 0x18E0, 0x18E0, 0x18E0, 0x1900, 0x1900, 0x1900, 0x1900, 0x1900, 0x1900, 0x1900, 0x1900, // 80 - 95
												  0x1920, 0x1920, 0x1920, 0x1920, 0x1920, 0x1920, 0x1920, 0x1920, 0x1940, 0x1940, 0x1940, 0x1940, 0x1940, 0x1940, 0x1940, 0x1940, // 96 - 111
												  0x1960, 0x1960, 0x1960, 0x1960, 0x1960, 0x1960, 0x1960, 0x1960, 0x1980, 0x1980, 0x1980, 0x1980, 0x1980, 0x1980, 0x1980, 0x1980, // 112 - 127
												  0x19A0, 0x19A0, 0x19A0, 0x19A0, 0x19A0, 0x19A0, 0x19A0, 0x19A0, 0x19C0, 0x19C0, 0x19C0, 0x19C0, 0x19C0, 0x19C0, 0x19C0, 0x19C0, // 128 - 143 
												  0x19E0, 0x19E0, 0x19E0, 0x19E0, 0x19E0, 0x19E0, 0x19E0, 0x19E0, 0x1A00, 0x1A00, 0x1A00, 0x1A00, 0x1A00, 0x1A00, 0x1A00, 0x1A00, // 144 - 159 
												  0x1A20, 0x1A20, 0x1A20, 0x1A20, 0x1A20, 0x1A20, 0x1A20, 0x1A20, 0x1A40, 0x1A40, 0x1A40, 0x1A40, 0x1A40, 0x1A40, 0x1A40, 0x1A40, // 160 - 175 
												  0x1A60, 0x1A60, 0x1A60, 0x1A60, 0x1A60, 0x1A60, 0x1A60, 0x1A60, 0x1A80, 0x1A80, 0x1A80, 0x1A80, 0x1A80, 0x1A80, 0x1A80, 0x1A80, // 176 - 191 
												  0x1AA0, 0x1AA0, 0x1AA0, 0x1AA0, 0x1AA0, 0x1AA0, 0x1AA0, 0x1AA0, 0x1AC0, 0x1AC0, 0x1AC0, 0x1AC0, 0x1AC0, 0x1AC0, 0x1AC0, 0x1AC0, // 192 - 207 
												  0x1AE0, 0x1AE0, 0x1AE0, 0x1AE0, 0x1AE0, 0x1AE0, 0x1AE0, 0x1AE0, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, // 208 - 223 
												  0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF  // 224 - 239
	};
	struct BorderColors
	{
		uint16_t x;
